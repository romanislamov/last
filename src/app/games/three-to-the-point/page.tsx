  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-jaro text-white">
      ...
      <div className="max-w-3xl mx-auto my-8 space-y-4 text-gray-200 text-sm md:text-base leading-relaxed">
        <p>
          Three to the Point is an immersive turn-based puzzle platformer that challenges players with
          creative problem-solving and strategic thinking. You control a team of unique characters,
          each with distinct abilities, navigating through beautifully designed islands filled with
          puzzles and hidden secrets. The goal is simple: plan your moves, position your characters
          strategically, and solve intricate puzzles to progress.
        </p>
        <p>
          The game’s world evolves as you unlock new islands, each with fresh mechanics and puzzles. As
          you journey through colorful, hand-drawn landscapes, you will meet quirky characters who
          share their stories, provide hints, and guide you through challenges.
        </p>
        <p>
          Three to the Point offers a family-friendly experience suitable for all ages. The simple
          mechanics are easy to learn, but each level brings new challenges, rewarding creativity and
          careful planning. Even the simplest puzzles have multiple solutions, making every move count.
        </p>
        <p>
          With vibrant visuals, charming characters, and clever puzzle designs, Three to the Point
          immerses players in a relaxing yet engaging world. Whether you are a casual gamer or puzzle
          enthusiast, you will enjoy unlocking new islands, solving puzzles, and uncovering the story,
          making this the perfect game for a relaxing yet intellectually stimulating adventure.
        </p>
      </div>
