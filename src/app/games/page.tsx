// Example Path: src/app/games/page.tsx (or where your all games page lives)
...
// --- Data Definition ---
// Helper function to create simple slugs (optional, can define slugs manually)
...
// Define the game data directly in this file
const allGamesData = [
    {
        ...
        description: "An action RPG with turn-based strategy and roguelike elements set in a dark fantasy world. Battle the forces of darkness through procedurally generated maps and dynamic quests.",
        imageSrc: "/game1.png",
    ...
    },
    {
        ...
        description: "An exciting puzzle and strategy game combining creature collection with gravity-based mechanics. Use gravity to manipulate objects and solve complex levels.",
        imageSrc: "/game2.png",
    ...
    },
    {
        ...
        tagline: "Casual turn Based Strategy Game.",
        description: "An engaging puzzle game combining strategy and logic. Control a unique robot to manipulate blocks, create paths, and solve increasingly complex challenges.",
        imageSrc: "/game3.png",
    ...
    },
    {
        ...
        tagline: "Casual turn Based Strategy Game.",
        description: "An immersive turn-based puzzle platformer. Control unique characters, use distinct abilities, and navigate beautifully designed islands filled with puzzles.",
        imageSrc: "/game4.png",
...
export default function AllGamesPage() {
    // Define text shadow for outline effect - reuse if needed elsewhere or define here
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                {/* Map directly over the locally defined data */}
