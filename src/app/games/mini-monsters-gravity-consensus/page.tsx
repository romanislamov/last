// Example Path: src/components/GamePages/Game2Page.tsx
// Or integrate into src/app/games/mini-monsters-gravity-consensus/page.tsx
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-jaro text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 max-w-5xl mx-auto">
                <Image
                    src="/game21.png" // Make sure this image exists
                ...
                />
                <Image
                    src="/game22.png" // Make sure this image exists
