// Example Path: src/components/GamePages/Game1Page.tsx
// Or integrate into src/app/games/the-dark-lands/page.tsx

import React from 'react';
import Image from 'next/image';
import Link from 'next/link';

// Data for all games (needed for "Other Games" section)
const allGames = [
...
// Helper component for the "Other Games" card
...
export default function Game1Page() {
    ...
    const textOutlineShadow = "[-1px_-1px_0_#333,1px_-1px_0_#333,-1px_1px_0_#333,1px_1px_0_#333]"; // Dark gray outline
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-jaro text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 max-w-5xl mx-auto">
                <Image
                    src="/game11.png" // Make sure this image exists
                ...
                />
                <Image
                    src="/game12.png" // Make sure this image exists
